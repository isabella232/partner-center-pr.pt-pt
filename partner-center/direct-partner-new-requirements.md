...
description: Saiba como atender aos mais recentes requisitos de apoio e serviços para se tornar um parceiro de conta direta no programa Fornecedor de Soluções em Nuvem da Microsoft (CSP).
ms.topic: article
...
Se decidir passar de um negócio de contas diretas para um negócio de revendedor indireto, há vários passos que terá de dar. Para saber mais sobre a transição, leia [a Transição de Fornecedor de Soluções em Nuvem (CSP) parceiro direto para revendedor indireto CSP](transition-direct-to-indirect.md).
