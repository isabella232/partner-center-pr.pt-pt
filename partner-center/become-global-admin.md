...
Quando a sua empresa cria pela primeira vez uma conta no Partner Center, é provável que os seus colaboradores não tenham sido atribuídos às funções necessárias para começar a trabalhar.  Para trabalhar no Centro de Parceiros todos precisam de ter um papel, que inclui permissões, que lhes são atribuídas.  
