...
Também pode utilizar [apis do Partner Center](/partner-center/develop/) para criar subscrições de marketplace comercial para os seus clientes. (Para obter mais informações sobre a utilização de APIs do Partner Center, consulte [Criar uma subscrição para produtos de marketplace comercial](/partner-center/develop/create-subscription-azure-marketplace-products).)
...
5. **Selecione Veja tudo** no topo da lista do Mercado Azure.

6. Para reduzir a sua lista, utilize filtros no topo da lista do Marketplace. Por exemplo, pode selecionar **a Microsoft** ou o **Partner** da lista **de Publisher** para visualizar apenas ofertas da Microsoft ou de um editor ISV.
