...
ms.locfileid: "129070810"
---
# <a name="partner-center-account-management"></a>Gestão de conta do Partner Center

**Funções adequadas**: Administração global | Administrador de conta

A conta que cria no Partner Center quando se inscreve é o seu email de trabalho e mais as informações do seu negócio. Depois de criar uma conta, terminará a configuração do perfil completo da sua empresa, incluindo detalhes de suporte, isenções fiscais de arquivo, se for caso disso, e informações de contacto primários. A conta da sua empresa também incluirá contas de utilizadores para qualquer pessoa da sua equipa que utilize o Partner Center. O trabalho que podem fazer inclui a adição ou gestão de clientes, a venda de subscrições, o trabalho com faturação e faturação, a criação de perfis de negócio, a gestão de referenciações, o trabalho com programas de incentivos, a prestação de apoio, e muito mais.
...
Todos os parceiros comerciais e desenvolvedores acedem à **gestão de conta** no Partner Center, insinando-se no painel de [instrumentos](https://partner.microsoft.com/dashboard) do Partner Center e selecionando o ícone de engrenagem Definições e, em seguida, selecione **as definições de Conta**. Já não tem de escolher entre as definições de Partner e Developer. Todos os perfis e configurações estão agora combinados.

:::image type="content" source="images/accountsettings/opening.png" alt-text="Screenshot mostrando o ícone de engrenagem Definições expandido.":::

### <a name="locate-your-mpn-id"></a>Localizar o ID do MPN

Quer seja um parceiro ou um desenvolvedor, use o seu ID MPN para coisas como registar bilhetes de apoio. O seu ID MPN está localizado na página **de informações legais.** Também pode encontrá-lo no **perfil identidade.**
...
No exemplo abaixo, o utilizador inscrito faz parte das três contas em destaque. O utilizador pode alternar entre eles clicando numa conta.
...
O e-mail de contacto principal é o que usaremos para notificá-lo sobre a verificação da sua conta. É importante que o e-mail que fornece para o contacto primário seja um que seja regularmente gerido e vigiado.  

Saiba mais sobre [a Verificação e informações da sua conta.](verification-responses.md)

### <a name="tenants-profile"></a>Perfil dos inquilinos

Esta página contém todas as informações sobre os seus inquilinos AD Azure, tanto comerciais como desenvolvedores. Este perfil é onde o administrador global pode associar novos inquilinos à conta global do parceiro.
...
### <a name="account-merge-profile"></a>Perfil de fusão de conta

Quando convida uma empresa que tem uma conta ativa no Partner Center para fundir a sua conta com a sua, essa informação é gerida na página de fusão da **Conta.** Procure o ID da MPN para a empresa que gostaria de convidar a fundir-se com a sua, ver fusões atuais e enviar convites para empresas. Aceite ou rejeite um convite para fundir a sua conta da empresa na conta de outra empresa aqui. Para mais detalhes, consulte [a Fusão da sua conta de parceiro com outra conta de parceiro.](merge-accounts.md)

## <a name="payout-and-tax"></a>Pagamento e imposto
...
2. Selecione o ícone de engrenagem Definições e, em seguida, [**as minhas preferências**](https://partner.microsoft.com/dashboard/engagement/preference).

3. Selecione **Alterar,** atualize o endereço de e-mail e **selecione Guardar**.
...
3. Na página de perfil, verá as suas informações pessoais no que diz respeito ao seu trabalho e aos seus dados de aprendizagem, exames e certificações.

4. Selecione o **separador Funções e permissões** para ver todas as funções que lhe foram atribuídas e as permissões que essas funções fornecem.
...
- [Benefícios de adesão à Rede de Parceiros da Microsoft](mpn-overview.md)
- [Programa Fornecedor de Soluções Cloud](./enrolling-in-the-csp-program.md)
- [Office Loja](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/office)

Para saber mais sobre a inscrição nos programas do Partner Center, consulte também [os recursos da rede Partner.](https://partner.microsoft.com/)
...
- [Descubra ofertas e preços no mercado comercial partner Center](csp-commercial-marketplace-discover.md)
