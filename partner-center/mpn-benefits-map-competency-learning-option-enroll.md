...
Para se qualificar e inscrever-se numa opção específica de Aprendizagem de uma competência de prata, reveja os requisitos de prata dessa competência para garantir que os cumpre. Então, siga estes passos:
