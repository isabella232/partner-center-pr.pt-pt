...
Anúncios de 2020: [janeiro](2020-january.md)  |  [February](2020-february.md)  |  [fevereiro abril](2020-march.md)  |  [abril](2020-april.md)  |  [May](2020-may.md)  |  [junho](2020-june.md) Julho [agosto](2020-august.md)

________________

## <a name="changes-to-enterprise-voice-and-audio-conferencing-extended-dial-out-launches"></a><a name="10"></a>Alterações nos lançamentos de marcação prolongada de voz e áudio da Enterprise Voice
...
O lançamento da Enterprise Voice e E5 e A5 com Call Minutes foi cancelado. O prolongamento da marcação para os Estados Unidos e Canadá está adiado para 1 de setembro de 2020.

### <a name="details"></a>Detalhes

Não vamos lançar o Plano de Voz empresarial 1 e 2 e a inclusão de atas de chamada doméstica nos planos E5 e A5, como estava previsto para 1 de agosto de 2020. O lançamento foi colocado em espera indefinidamente. 
...
#### <a name="enterprise-voice-plans-and-e5-and-a5-with-calling-minutes-launch-canceled"></a>Enterprise Voice Plans e E5 e A5 com lançamento de Atas De Chamada cancelados
 
**Perguntas Mais Frequentes**

- **Porque é que não estamos a lançar a Enterprise Voice e a E5/A5 com atas de chamada?** Não vamos lançar devido à rápida evolução das condições do mercado. 
- **Lançaremos Enterprise Voice e E5/A5 com Minutos de Chamada mais tarde?** Não sabemos. Continuaremos a avaliar os dados do mercado e das vendas para determinar se o lançamento será reagendado. 
...
- **Os SKUs continuarão a figurar nas listas de preços de agosto?** Não. Os SKUs afetados aparecem na pré-visualização da tabela de preços, mas serão removidos das tabelas de preços publicadas no dia 1 de agosto. Os parceiros de campo e parceiros que descarregaram a lista de preços de pré-visualização devem substituir a sua cópia pela tabela de preços atualizada publicada a 1 de agosto. 
- **As ofertas vão aparecer nas tabelas de preços da CSP de agosto?** Não. Os SKUs afetados aparecem na pré-visualização da lista de preços, mas serão removidos das tabelas de preços da CSP publicadas no dia 1 de agosto. Os parceiros de campo e parceiros que descarregaram a lista de preços de pré-visualização devem substituir a sua cópia pela tabela de preços atualizada publicada a 1 de agosto.
- **Isto afetará as ofertas de adoção do Sistema De Telefone, Conferência sonora ou Comunicações Avançadas que foram anunciadas?** Não, essas ofertas ainda estarão disponíveis como planeado. 
- **As ofertas aparecerão no portal do cliente para a compra Web Direct?** Não.
- **Quais as SKUs/ofertas específicas que são afetadas?**
   ...
   |Microsoft 365 Enterprise Voice Plan 2|3137b0d0-cdf7-4a34-b55e-418546689789b|
   |Microsoft 365 Enterprise Voice Plan 1|Add-On para E5 0221eb93-7630-4e6a-8aa3-0d1a980e73a|
   |Microsoft 365 Enterprise Voice Plan 1|Add-On à E5 (Preços do Pessoal Sem Fins Lucrativos) cc2274e3-1337-4512-9d19-a8d4faf5fae0|
   |Microsoft 365 E5 com atas de chamada|83f14016-b947-48e8-a2ac-d92fe589fd67|
   |Microsoft 365 E5 com Atas de Chamada (Preços do Pessoal Sem Fins Lucrativos)|c2caa762-83f8-43c4-acec-ecad58b69d1b|
   |Escritório 365 E5 com atas de chamada|5d912774-4c9b-43ff-b2f2-6dfd65e7e4|
   |Escritório 365 E5 com Atas de Chamada (Preços do Pessoal Sem Fins Lucrativos)|27309aec-eff6-4c5e-91e9-bc5b7c5f083a|
   |Microsoft 365 A5 com atas de chamada para faculdade|454abc41-598d-4a1c-9c60-e4f5b5cf67f1|
   |Microsoft 365 A5 com atas de chamada para estudantes|1738b653-33bf-45d2-a77e-09fa13fb649d|
   |Escritório 365 A5 com atas de chamada para faculdade|fe9cae98-2f46-41df-868f-b05ed672f159|
   |Escritório 365 A5 com atas de chamada para estudantes|f8dfe4c7-828b-45eb-8e2c-e9a6daf9dd75|
...
- **As ofertas vão aparecer nas tabelas de preços da CSP de agosto?** Não. As ofertas não constarão da tabela de preços da CSP de agosto. As ofertas aparecem na pré-visualização da tabela de preços, mas serão removidas das tabelas de preços da CSP publicadas no dia 1 de agosto. Os parceiros que descarregaram a lista de preços de pré-visualização devem substituir a sua cópia pela tabela de preços atualizada publicada a 1 de agosto.
...
- Partilhe esta informação com todos os contactos apropriados na sua organização. Saiba mais sobre a oportunidade de parceiro teams calling no site da [Microsoft Teams](http://https://www.microsoft.com/microsoft-365/partners/calling-and-meetings).
...
- Os parceiros do Cloud Solution Provider podem visitar a [comunidade SDK e API Yammer do Partner Center](https://www.yammer.com/cloudpartnercommunity/#/Threads/show?threadId=786951767490560) para fazer perguntas se forem necessários mais esclarecimentos.
...
A partir de 21 de julho de 2020, os Parceiros podem começar a descarregar a versão de pré-visualização do **.NET Standard SDK Microsoft Partner Center** .NET SDK v1.16.1-preview, juntamente com **amostras atualizadas do Centro de Parceiros Públicos SDK GitHub** .

### <a name="details"></a>Detalhes

Os parceiros Direct Bill e Os Fornecedores Indiretos que participam no programa CSP são elegíveis para descarregar a versão mais recente de .NET standard SDK. Vamos migrar o Microsoft Partner Center SDK de .NET Framework para a plataforma .NET Standard 2.0. Estas alterações tornarão o SDK compatível com a aplicação existente utilizando o Quadro .NET 4.6.1 e superior. A Norma .NET suporta .NET Core 2.0 e superior.
...
## <a name="cloud-solution-provider-csp-incentive-for-eligible-microsoft-commercial-marketplace-offers-enhanced-for-fy21"></a><a name="7"></a>Incentivo do Cloud Solution Provider (CSP) para ofertas de mercado comercial elegíveis da Microsoft melhoradas para FY21
...
_______________
## <a name="new-capabilities-added-to-the-insights-reports-in-partner-center"></a><a name="6"></a>Novas capacidades adicionadas aos relatórios insights no Partner Center 
...
Foram adicionadas novas capacidades aos relatórios da Insights no Partner Center, permitindo aos parceiros realizar análises de dados ad-hoc com base nas suas necessidades de negócio e ver uma visão holística da formação realizada pelos colaboradores na sua organização.  Estas novas capacidades aumentam o conjunto robusto dos [relatórios insights existentes.](../partner-center-insights.md)

Nova visão geral das capacidades:

- **Exportação de dados brutos** habilitado para detalhes do cliente, detalhes de subscrição, utilização do Microsoft Azure, utilização do Office 365, utilização da Dynamics 365, utilização da Enterprise Mobility and Security (EMS), utilização do Power BI, formação e certificações, e Microsoft Learn. Para obter mais informações, consulte [este artigo](../pci-download-reports.md).

- **Novo painel de treino** que proporciona uma visão holística da formação realizada pelos colaboradores da sua organização. Para obter mais informações, consulte [este artigo](../pci-training-dashboard.md).

### <a name="what-is-insights"></a>O que é Insights?

O dashboard Insights in Partner Center dá-lhe uma visão unificada de 360 graus dos principais indicadores de desempenho (KPI) da sua organização parceira em produtos em nuvem como Office 365, Azure, Dynamics 365 e modelos de licenciamento como Cloud Solution Provider (CSP) e Enterprise Agreement (EA). São-lhe transmitidas informações inteligentes para que compreenda claramente o seu negócio com a Microsoft e possa tomar decisões com confiança.   

Para ver este painel de **instrumentos, selecione Insights** do menu de navegação à esquerda do Centro Parceiro. Este dashboard utiliza os mesmos dados subjacentes que a atual ferramenta de reporte myInsights, mas oferece visuais mais ricos e capacidades de reporte mais perspicazes e KPI's abrangendo clientes, subscrições, uso de licenças, competências e benefícios. Volte com frequência, pois continuaremos a trazer novos relatórios e capacidades para o painel insights.    
...
______________
## <a name="perpetual-software-in-the-cloud-solution-provider-program"></a><a name="5"></a>Software perpétuo no programa Cloud Solution Provider 
...
- Reveja todos os materiais de prontidão na coleção de galerias de recursos de prontidão de operações:  [Software perpétuo no programa Cloud Solution Provider](https://partner.microsoft.com/resources/collection/software-in-csp#/).
...
Parceiros que oferecem Microsoft Dynamics 365 através do programa Cloud Solution Provider (CSP) em todo o mundo, salvo especificação em contrário

### <a name="details"></a>Detalhes

#### <a name="upcoming-offers"></a>Próximas ofertas

**Oferta de pacote New Dynamics 365 Sales Premium**

A partir de 1 de agosto de 2020, a Microsoft lançará uma nova oferta de pacotes Dynamics 365 Sales Premium para clientes em todos os programas e regiões onde a Dynamics 365 Enterprise e a Dynamics 365 Sales Insights já estão disponíveis. 

Reveja o [ficheiro Dynamics CSP – agosto 2020 Excel](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-sales-premium-bundle-offer-for-csp-xls) para mais detalhes sobre as SKUs impactadas. 
...
Reveja o [documento Dynamics CSP -julho 2020 Excel](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-and-power-platform-offers-csp-july-2020-xls) para mais detalhes sobre as SKUs impactadas. 
...
## <a name="microsoft-has-ended-sales-of-the-microsoft-kaizala-pro-standalone-sku"></a><a name="2"></a>Microsoft terminou as vendas do Microsoft Kaizala Pro autónomo SKU
...
O Microsoft Kaizala Pro já não está disponível para clientes novos ou renovados. Estes clientes podem aceder à Kaizala através da transição para outras licenças Microsoft 365 e Office 365.

### <a name="impacted-audience"></a>Audiência impactada

Parceiros que vendem Microsoft Kaizala Pro autónomo SKU

### <a name="details"></a>Detalhes

A Microsoft está em processo de adicionar capacidades Kaizala Pro e algumas das suas funcionalidades mais utilizadas no Microsoft Teams, o hub da Microsoft 365 para o trabalho em equipa.

A partir de hoje, 1 de julho de 2020, a Microsoft vai encerrar as vendas do SKU autónomo Kaizala Pro para novos ou renovadores clientes. Os clientes existentes podem continuar a aceder ao serviço através da sua licença atual. Anunciamos esta mudança para os clientes da Kaizala no dia 1 de junho de 2020.

Kaizala e Teams continuarão a ser acessíveis como parte dos seguintes SKUs Microsoft 365 e Office 365:
...
[Microsoft 365 para Linha da Frente,](https://partner.microsoft.com/resources/collection/Microsoft-365-firstline-offer-updates)incluindo:
...
Esta mudança está a ser implementada para garantir que os novos e renovadores clientes estão licenciados para a transição de Kaizala para Equipas.
...
Microsoft Kaizala Pro (KAIZALA_STANDARD)
   ...
   |AAA-52249|Teste do Microsoft Kaizala Pro (preço do Governo)|Direct|
...
Microsoft Kaizala Pro (Oferta do Office 365) (KAIZALA_STANDARD_EAP)
   ...
   |AAD-28928|Microsoft Kaizala Pro (oferta do Office 365)|Direct|

Microsoft Kaizala Pro para docentes (KAIZALA_FACULTY)

   |**SKU**|**Descrição**|**Programa**|
   |-------------------|:------|:------|
   |AAA-51201|Microsoft Kaizala Pro para docente|CSP|
   |AAA-51197|Microsoft Kaizala Pro para docente|Direct|

Microsoft Kaizala Pro para docentes (Oferta do Office 365) (KAIZALA_FACULTY_ EAP)

   |**SKU**|**Descrição**|**Programa**|
   |-------------------|:------|:------|
   |AAD-28931|Microsoft Kaizala Pro para docentes (oferta do Office 365)|CSP|
   |AAD-28930|Microsoft Kaizala Pro para docentes (oferta do Office 365)|Direct|
...
Para saber mais sobre as ofertas microsoft 365 e Office 365 onde os clientes ainda podem aceder à Kaizala e às Equipas, visite os seguintes websites:
...
- [Microsoft 365 para Enterprise](https://www.microsoft.com/microsoft-365/compare-microsoft-365-enterprise-plans)
- [Microsoft 365 para Educação](https://www.microsoft.com/education/buy-license/microsoft365)
