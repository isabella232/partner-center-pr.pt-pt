...
_______________
## <a name="now-available-windows-7-year-2-esu-for-cloud-solution-provider-csp"></a><a name="6"></a>Agora disponível Windows 7 Year 2 ESU para Fornecedor de Soluções cloud (CSP)
...
O windows 7, ano 2 alargou os preços de segurança (ESU) está agora na [Galeria de Recursos](https://partner.microsoft.com/resources/collection/windows-esu-csp#/).
...
- [Página de FAQ](https://support.microsoft.com/help/4527873/itpro-faq-about-end-of-support-for-windows-7)
- [Página de suporte](/deployoffice/windows-7-support)
- [Galeria fornecedora de solução de nuvem](https://partner.microsoft.com/resources/collection/windows-esu-csp#/)
...
Fornecedores diretos de soluções cloud (CSP) e fornecedores indiretos
...
O Microsoft 365 F1 será atualizado com novos serviços. Uma nova oferta será lançada para substituir a F1 anterior no dia 15 de junho.
...
O Microsoft 365 F1 está disponível no partner center desde abril de 2020. Estão a ser feitos melhoramentos adicionando suporte para novos serviços: Exchange Kiosk e MS Search capabilites. Os novos serviços serão a provisionados automaticamente em quaisquer subscrições existentes com base nas ofertas originais de F1 até ao final de junho. As ofertas originais de F1 serão substituídas no dia 15 de junho com as novas ofertas de F1 (abaixo) para novas compras por subscrição.
...
Os parceiros com o atual produto Microsoft 365 F1 não têm qualquer ação. Os planos de serviço para o Exchange Kiosk e MS Search serão reabastecados até ao final de junho nos seus planos de serviço existentes.

Os parceiros que pretendam adquirir o Microsoft 365 F1 depois de 15 de junho devem utilizar as novas informações de F1 para garantir que estão a adquirir a oferta correta. O Novo F1 oferece ID e outras informações serão atualizadas na atualização da lista de preços do Fornecedor de Solução Cloud (CSP) de julho no dia 1 de julho.
...
## <a name="windows-server-software-subscriptions-media-refresh-for-cloud-solution-provider-csp"></a><a name="2"></a>Subscrições de software do Windows Server Media Refresh para Fornecedor de Solução cloud (CSP) 
...
A Microsoft anuncia o lançamento de meios atualizados para cloud solution provider (CSP) a 12 de junho de 2020 para subscrições de software do Windows Server.
...
A Microsoft anuncia o lançamento de meios atualizados para cloud solution provider (CSP) a 12 de junho de 2020 para subscrições de software do Windows Server.   Os produtos de subscrições de software do Windows Server atualizados incluem:
