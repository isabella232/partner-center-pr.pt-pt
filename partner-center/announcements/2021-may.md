...
Saiba mais ao ver o nosso guia para [obter informações de referência no Partner Center](/partner-center/referral-insights).
...
Para obter instruções detalhadas, consulte [configurar um perfil bancário predefinido](/partner-center/incentives-create-and-manage-your-payout-and-tax-profiles#set-up-a-default-bank-profile).
...
Uma inscrição só é considerada completa quando o pagamento e o perfil fiscal que forneceu para a inscrição foram validados pela Microsoft. Saiba mais sobre os perfis de pagamento e impostos [aqui.](/partner-center/incentives-create-and-manage-your-payout-and-tax-profiles)
