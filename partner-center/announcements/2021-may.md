...
________________
## <a name="deprecation-of-microsoft-365-business-voice-getting-started-wizard-gsw"></a><a name="12"></a>Depreciação do Microsoft 365 Business Voice Getting Started Wizard (GSW)
...
________________
## <a name="may-cloud-solution-provider-csp-community-update-and-reminders"></a><a name="11"></a>Pode cloud solution provider (CSP) atualização e lembretes da comunidade
