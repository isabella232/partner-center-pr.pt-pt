...
<span data-ttu-id="aa2f8-137">Esta é uma questão conhecida, e será corrigida em breve.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-137">This is a known issue, and will be fixed soon.</span></span>
...
### <a name="categories"></a><span data-ttu-id="aa2f8-162">Categorias</span><span class="sxs-lookup"><span data-stu-id="aa2f8-162">Categories</span></span>
...
- <span data-ttu-id="aa2f8-185">Governo[(requisitos de elegibilidade)](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=6)</span><span class="sxs-lookup"><span data-stu-id="aa2f8-185">Government ([eligibility requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=6))</span></span>
...
#### <a name="partnerbenefits"></a><span data-ttu-id="aa2f8-231">Benefícios do parceiro</span><span class="sxs-lookup"><span data-stu-id="aa2f8-231">Partner benefits</span></span>  
...
### <a name="next-steps"></a><span data-ttu-id="aa2f8-265">Passos seguintes</span><span class="sxs-lookup"><span data-stu-id="aa2f8-265">Next steps</span></span>
...
### <a name="summary"></a><span data-ttu-id="aa2f8-276">Resumo</span><span class="sxs-lookup"><span data-stu-id="aa2f8-276">Summary</span></span>
...
[<span data-ttu-id="aa2f8-288">Registe-se aqui para se juntar à chamada.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-288">Register here to join the call.</span></span>](https://globalpbocomm.eventbuilder.com/GlobalCSP)
...
<span data-ttu-id="aa2f8-298">Reveja os recursos comunitários e registe-se para a Chamada Comunitária Q&A.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-298">Review the community resources and register for the Community Call Q&A.</span></span>
...
<span data-ttu-id="aa2f8-311">Os parceiros podem agora ver a análise de negócios liderados por parceiros, além de ofertas privadas e co-venda.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-311">Partners can now view analytics for partner-led deals in addition to private and co-sell deals.</span></span>
...
- <span data-ttu-id="aa2f8-323">Data: 2021-05-07</span><span class="sxs-lookup"><span data-stu-id="aa2f8-323">Date: 2021-05-07</span></span>
...
- <span data-ttu-id="aa2f8-362">Data: 2021-05-05</span><span class="sxs-lookup"><span data-stu-id="aa2f8-362">Date: 2021-05-05</span></span>
...
<span data-ttu-id="aa2f8-387">Se tiver alguma dúvida sobre estas ofertas, consulte as suas comunidades Yammer relevantes.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-387">If you have any questions about these offers, check your relevant Yammer communities.</span></span>
...
#### <a name="expanding-opportunities-for-partners"></a><span data-ttu-id="aa2f8-401">Oportunidades de expansão para parceiros</span><span class="sxs-lookup"><span data-stu-id="aa2f8-401">Expanding opportunities for partners</span></span>
...
<span data-ttu-id="aa2f8-432">Para quaisquer questões relacionadas com esta notificação, contacte [o Suporte do Centro de Parceiros](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals).</span><span class="sxs-lookup"><span data-stu-id="aa2f8-432">For any questions related to this notification, contact [Partner Center support](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals).</span></span>

### <a name="change-log"></a><span data-ttu-id="aa2f8-433">Change log</span><span class="sxs-lookup"><span data-stu-id="aa2f8-433">Change log</span></span>

- <span data-ttu-id="aa2f8-434">4 de maio de 2021: Lembrete final da próxima depreciação da qualificação do GET</span><span class="sxs-lookup"><span data-stu-id="aa2f8-434">May 4, 2021: Final reminder of upcoming deprecation of GET qualification</span></span>

- <span data-ttu-id="aa2f8-435">9 de abril de 2021: Lembrete da próxima depreciação da qualificação do GET</span><span class="sxs-lookup"><span data-stu-id="aa2f8-435">April 9, 2021: Reminder of upcoming deprecation of GET qualification</span></span> 

- <span data-ttu-id="aa2f8-436">Fevereiro: Prazos atualizados para depreciação das qualificações GET & PUT</span><span class="sxs-lookup"><span data-stu-id="aa2f8-436">February: Updated timelines for deprecation of GET & PUT qualifications</span></span>

- <span data-ttu-id="aa2f8-437">Janeiro: Lembrete das próximas depreciações das qualificações GET & PUT</span><span class="sxs-lookup"><span data-stu-id="aa2f8-437">January: Reminder of upcoming deprecations of GET & PUT qualifications</span></span>

________________
## <a name="corrections-to-may-1-2021-license-based-services-price-list"></a><a name="3"></a><span data-ttu-id="aa2f8-438">Correções até 1 de maio de 2021 Lista de preços dos serviços baseados em licenças</span><span class="sxs-lookup"><span data-stu-id="aa2f8-438">Corrections to May 1, 2021 License-based services price list</span></span>

### <a name="categories"></a><span data-ttu-id="aa2f8-439">Categorias</span><span class="sxs-lookup"><span data-stu-id="aa2f8-439">Categories</span></span>

- <span data-ttu-id="aa2f8-440">Data: 2021-05-04</span><span class="sxs-lookup"><span data-stu-id="aa2f8-440">Date: 2021-05-04</span></span>

- <span data-ttu-id="aa2f8-441">Ofertas/Mercados</span><span class="sxs-lookup"><span data-stu-id="aa2f8-441">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="aa2f8-442">Audiência impactada</span><span class="sxs-lookup"><span data-stu-id="aa2f8-442">Impacted audience</span></span>

<span data-ttu-id="aa2f8-443">Fornecedores indiretos e parceiros de conta direta que transfiram serviços baseados em licenças no programa Cloud Solution Provider.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-443">Indirect providers and direct bill partners transacting license-based services in the Cloud Solution Provider program.</span></span>

### <a name="details"></a><span data-ttu-id="aa2f8-444">Detalhes</span><span class="sxs-lookup"><span data-stu-id="aa2f8-444">Details</span></span>

<span data-ttu-id="aa2f8-445">A lista de preços dos serviços baseados em licenças publicada a 1 de maio de 2021 incluía um preço incorreto para USD para o Microsoft 365 Business Standard.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-445">The price list for license-based services posted on May 1, 2021 included an incorrect price for USD for Microsoft 365 Business Standard.</span></span> <span data-ttu-id="aa2f8-446">O Preço da Lista publicado era $8, quando devia ser $10.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-446">The List Price published was $8, when it should have been $10.</span></span> <span data-ttu-id="aa2f8-447">A lista de preços dos serviços baseados em licença foi atualizada no dia 3 de março de 2021 às 11:30 PST com as correções.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-447">The license-based services price list was updated on March 3, 2021 at 11:30am PST with the corrections.</span></span> <span data-ttu-id="aa2f8-448">Estas correções só se aplicavam:</span><span class="sxs-lookup"><span data-stu-id="aa2f8-448">These corrections were only applicable to:</span></span>

- <span data-ttu-id="aa2f8-449">Nome da oferta: Microsoft 365 Business Standard</span><span class="sxs-lookup"><span data-stu-id="aa2f8-449">Offer Name: Microsoft 365 Business Standard</span></span>

- <span data-ttu-id="aa2f8-450">ID da oferta: 031c9e47-4802-4248-838e-778fb1d2cc05</span><span class="sxs-lookup"><span data-stu-id="aa2f8-450">Offer ID: 031c9e47-4802-4248-838e-778fb1d2cc05</span></span>

- <span data-ttu-id="aa2f8-451">Moedas: USD</span><span class="sxs-lookup"><span data-stu-id="aa2f8-451">Currencies: USD</span></span>

- <span data-ttu-id="aa2f8-452">Antes: Preço da lista: $8</span><span class="sxs-lookup"><span data-stu-id="aa2f8-452">Before: List Price: $8</span></span>

- <span data-ttu-id="aa2f8-453">Depois: Preço da lista: $10</span><span class="sxs-lookup"><span data-stu-id="aa2f8-453">After: List Price: $10</span></span>

<span data-ttu-id="aa2f8-454">Estas alterações aplicam-se apenas à oferta acima referida.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-454">These changes only apply to the above offer.</span></span> <span data-ttu-id="aa2f8-455">Outras ofertas não tinham correções.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-455">Other offers had no corrections.</span></span> <span data-ttu-id="aa2f8-456">Este foi apenas um erro da Lista de Preços, não um erro de preço real que irá afetar a faturação durante este tempo.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-456">This was a Price List error only, not an actual price error that will affect invoicing during this time.</span></span>

### <a name="next-steps-and-resources"></a><span data-ttu-id="aa2f8-457">Próximos passos e recursos</span><span class="sxs-lookup"><span data-stu-id="aa2f8-457">Next steps and resources</span></span>

- <span data-ttu-id="aa2f8-458">Os parceiros que transacionam serviços baseados em licenças devem descarregar a lista de preços mais recente.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-458">Partners who transact license-based services should download the latest price list.</span></span>

________________
## <a name="announcement-of-state-owned-entity-qualification"></a><a name="2"></a><span data-ttu-id="aa2f8-459">Anúncio da qualificação da Entidade Estatal</span><span class="sxs-lookup"><span data-stu-id="aa2f8-459">Announcement of State Owned Entity qualification</span></span>

### <a name="categories"></a><span data-ttu-id="aa2f8-460">Categorias</span><span class="sxs-lookup"><span data-stu-id="aa2f8-460">Categories</span></span>

- <span data-ttu-id="aa2f8-461">Data: 2021-05-04</span><span class="sxs-lookup"><span data-stu-id="aa2f8-461">Date: 2021-05-04</span></span>
- <span data-ttu-id="aa2f8-462">Capacidades</span><span class="sxs-lookup"><span data-stu-id="aa2f8-462">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="aa2f8-463">Audiência impactada</span><span class="sxs-lookup"><span data-stu-id="aa2f8-463">Impacted audience</span></span>

<span data-ttu-id="aa2f8-464">Todos os parceiros cloud solution partner (CSP) que vendem a indústrias especializadas</span><span class="sxs-lookup"><span data-stu-id="aa2f8-464">All Cloud Solution Partner (CSP) partners selling to specialized industries</span></span>

### <a name="details"></a><span data-ttu-id="aa2f8-465">Detalhes</span><span class="sxs-lookup"><span data-stu-id="aa2f8-465">Details</span></span>

<span data-ttu-id="aa2f8-466">Como parte do nosso compromisso de ajudar parceiros e clientes a gerir o seu negócio com base na confiança, no dia 7 de maio vamos convidar parceiros de todo o mundo a declarar se eles têm clientes que se qualificam como Entidade Estatal.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-466">As part of our commitment to help partners and customers run their business based on trust, on May 7 we’ll be inviting partners worldwide to declare whether they have customers that qualify as a State Owned Entity.</span></span> <span data-ttu-id="aa2f8-467">Para saber mais sobre a elegibilidade, consulte os critérios da [Entidade Estatal | Conformidade ética &.](https://www.microsoft.com/legal/compliance/anticorruption/criteria)</span><span class="sxs-lookup"><span data-stu-id="aa2f8-467">To learn more about eligibility, see [State Owned Entity Criteria | Ethics & Compliance](https://www.microsoft.com/legal/compliance/anticorruption/criteria).</span></span> <span data-ttu-id="aa2f8-468">Os parceiros podem declarar os seus clientes como Entidade Estatal através da opção de qualificações especiais ao criar um novo cliente.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-468">Partners can declare their customers as State Owned Entity via the special qualifications option when creating a new customer.</span></span>

<span data-ttu-id="aa2f8-469">Para obter uma amostra de API, consulte [a qualificação de um cliente assíncroneamente](/partner-center/develop/get-customer-qualification-asynchronous.md).</span><span class="sxs-lookup"><span data-stu-id="aa2f8-469">For an API sample, see [Get a customer's qualification asynchronously](/partner-center/develop/get-customer-qualification-asynchronous.md).</span></span>

### <a name="next-steps"></a><span data-ttu-id="aa2f8-470">Passos seguintes</span><span class="sxs-lookup"><span data-stu-id="aa2f8-470">Next steps</span></span>

<span data-ttu-id="aa2f8-471">Rever os [critérios de elegibilidade.](https://www.microsoft.com/legal/compliance/anticorruption/criteria)</span><span class="sxs-lookup"><span data-stu-id="aa2f8-471">Review the [eligibility criteria](https://www.microsoft.com/legal/compliance/anticorruption/criteria).</span></span>

________________
## <a name="view-this-months-product-launches-and-offers"></a><a name="1"></a><span data-ttu-id="aa2f8-472">Veja os lançamentos e ofertas deste mês</span><span class="sxs-lookup"><span data-stu-id="aa2f8-472">View this month’s product launches and offers</span></span>

### <a name="categories"></a><span data-ttu-id="aa2f8-473">Categorias</span><span class="sxs-lookup"><span data-stu-id="aa2f8-473">Categories</span></span>

- <span data-ttu-id="aa2f8-474">Data: 2021-05-03, atualizado 2021-05-07</span><span class="sxs-lookup"><span data-stu-id="aa2f8-474">Date: 2021-05-03, updated 2021-05-07</span></span>
- <span data-ttu-id="aa2f8-475">Ofertas | Aplicações empresariais</span><span class="sxs-lookup"><span data-stu-id="aa2f8-475">Offers | Business Applications</span></span>

### <a name="summary"></a><span data-ttu-id="aa2f8-476">Resumo</span><span class="sxs-lookup"><span data-stu-id="aa2f8-476">Summary</span></span>

<span data-ttu-id="aa2f8-477">O calendário de [lançamento do produto](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) de maio de 2021 já foi publicado.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-477">The May 2021 [product launch calendar](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) is now published.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="aa2f8-478">Audiência impactada</span><span class="sxs-lookup"><span data-stu-id="aa2f8-478">Impacted audience</span></span>

<span data-ttu-id="aa2f8-479">Todos os parceiros que transacionam através do programa Cloud Solution Provider (CSP)</span><span class="sxs-lookup"><span data-stu-id="aa2f8-479">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="aa2f8-480">Detalhes</span><span class="sxs-lookup"><span data-stu-id="aa2f8-480">Details</span></span>

<span data-ttu-id="aa2f8-481">O calendário de [lançamento do produto](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) de maio de 2021 já está disponível na galeria de recursos de prontidão operações.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-481">The May 2021 [product launch calendar](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) is now available in the Operations readiness resource gallery.</span></span> <span data-ttu-id="aa2f8-482">Veja aqui os próximos lançamentos e ofertas de produtos.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-482">View the upcoming product launches and offers here.</span></span>

### <a name="next-steps"></a><span data-ttu-id="aa2f8-483">Passos seguintes</span><span class="sxs-lookup"><span data-stu-id="aa2f8-483">Next steps</span></span>

<span data-ttu-id="aa2f8-484">Reveja o [calendário de lançamento](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) do produto e partilhe a informação com as partes interessadas apropriadas na sua organização.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-484">Review the [product launch calendar](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) and share the information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="aa2f8-485">Perguntas?</span><span class="sxs-lookup"><span data-stu-id="aa2f8-485">Questions?</span></span>

<span data-ttu-id="aa2f8-486">Para mais perguntas sobre estas ofertas, consulte as suas comunidades Yammer relevantes.</span><span class="sxs-lookup"><span data-stu-id="aa2f8-486">For any further questions about these offers, check your relevant Yammer communities.</span></span>