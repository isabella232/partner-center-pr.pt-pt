...
Anúncios para 2020: [janeiro 2020](2020-january.md)  |  [fevereiro 2020](2020-february.md) | março de 2020 | [abril de 2020](2020-april.md)  |  [maio de 2020](2020-may.md)

_________________

## <a name="microsoft-will-rename-office-365-small-and-medium-business-smb-offers-from-april-21-2020"></a><a id="7"/></a>Microsoft vai mudar o nome Office 365 ofertas de pequenas e médias empresas (SMB) a partir de 21 de abril de 2020
...
Todos os Fornecedor de Soluções em Nuvem parceiros (CSP).

### <a name="details"></a>Detalhes

No dia 21 de abril de 2020, vamos mudar os nomes das nossas ofertas Office 365 SMB:
...
- Microsoft 365 O negócio tornar-se-á **Microsoft 365 Empresas Premium.** Este continua a ser o nosso Hero SKU para SMBs de alta qualidade à procura de segurança adicional, dispositivo e valor de identidade.
...
Não há alterações nos preços, funcionalidades ou modelo de negócio. Também não há alterações de nomeação para Office 365 Enterprise SKUs e skus Microsoft 365 Enterprise. Todo o SKU e a oferta de renomeação fluirão automaticamente para nomes de subscrição no Partner Center.

### <a name="partner-opportunity"></a>Oportunidade de parceiro

Este renome permite que os clientes compreendam melhor o valor incremental incluído em cada oferta, permitindo-lhe posicionar melhor as oportunidades de venda para as suas contas.

Aborda também inconsistências de nome nos planos de negócios Office 365/Microsoft 365. Da mesma forma, este renomeamento separa claramente as aplicações de Office fundamentais, vendidas através da nova Microsoft 365 Apps para Pequenas e Médias Empresas/empresa, de planos mais amplos.

### <a name="additional-resources"></a>Recursos adicionais

Visite a nossa [página de aterragem do M365 Partner](https://www.microsoft.com/microsoft-365/partners/smb-sku-rename) para saber mais.
...
Preste especial atenção aos seus colegas em Operações de Vendas e Marketing, uma vez que poderão necessitar de atualizar as garantias do produto para refletir os novos nomes.
...
Estão disponíveis novas capacidades para ajudar os clientes a transferir as suas assinaturas CSP de inquilinos de faturação direta para inquilinos de fornecedores indiretos.
...
Estão disponíveis novas capacidades para transferir as assinaturas CSP dos clientes de inquilinos de faturação direta para inquilinos de prestadores indiretos. Esta nova funcionalidade irá facilitar a transição para parceiros de conta diretas para revendedores indiretos, ajudando a acelerar o crescimento do negócio dentro do programa.

Reveja a página [da CSP](../csp-offers.md) para mais informações.

>[!NOTE] 
>As transferências apenas suportam subscrições licenciadas e subscrições Azure. Terá de transferir manualmente o seu plano Azure e as compras de mercado comercial. Por favor, note que isto envolve cancelar e renovar as assinaturas descritas nos seguintes documentos: [Plano Azure](../azure-plan-lp.md) e [mercado comercial.](../csp-commercial-marketplace-manage.md) Uma vez que as subscrições de servidores e reservas Azure são uma compra única, estas não precisarão de ser transferidas para um inquilino de fornecedor indireto. Visite o CSP para mais informações.
...
## <a name="new-microsoft-365-entry-level-sku-for-firstline-workers---csp"></a><a id="5"/></a>Novo Microsoft 365 SKU de nível de entrada para trabalhadores da Firstline - CSP
...
No dia 1 de abril de 2020, a Microsoft introduzirá novas ofertas na Microsoft 365 a linha F-SKU, proporcionando melhor valor aos Trabalhadores da Firstline e oportunidades de crescimento para os nossos parceiros.
...
Esta alteração só afeta os utilizadores comerciais e governamentais.

### <a name="details"></a>Detalhes

No dia 1 de abril de 2020, a Microsoft introduzirá um novo SKU de nível de entrada e reposicionará a linha Microsoft 365 Enterprise SKU.
...
Estas alterações proporcionarão um melhor valor para os Trabalhadores da Primeira Linha e permitirão que os parceiros aproveitem uma oportunidade significativa de crescimento do utilizador.
...
**O valor adicional será preenchido nos seus planos M365 F1, O/M365 F3 no dia 1 de abril de 2020.**
...
- Microsoft Planner será incluído em O/M365 F-SKUs por padrão
...
Por favor, familiarize-se com a lista de preços de pré-visualização. Por favor, lembre-se que no dia 1 de abril de 2020, Microsoft 365 F0 será remarcado Microsoft 365 F1. Pelo contrário, Microsoft 365 F1 será remarcado Microsoft 365 F3.
...
>[!NOTE] 
>O **guia De Criação de um cliente de educação no Partner Center** inclui agora instruções passo a passo para como corrigir a informação do cliente e reenviar se o cliente tiver falhado na verificação.
...
- Para contactar apoio se novo parceiro vender ofertas de educação removidas (já não é necessário): 13 de janeiro de 2020
...
## <a name="microsoft-365-cloud-service-provider-updates--april-2020"></a><a id="3"/></a>Microsoft 365 Atualizações do Fornecedor de Serviços cloud – abril de 2020
...
A 1 de abril de 2020, a Microsoft está a expandir a amplitude e o valor dos planos de Microsoft 365, proporcionando mais oportunidades de clientes e potenciando o acesso aos mercados dos parceiros.
...
Consulte a seguinte oferta na lista de preços de pré-visualização: Microsoft 365 E3 para RPA não atempresa: ec3ac2d1-dd66-475a-95c8-59c32c472778

### <a name="teams-premium-messaging"></a>Teams Premium Mensagens
...
Serão feitas as seguintes alterações aos produtos Dynamics Biz Apps e Power Platform, a partir de 1 de abril de 2020:
...
- [Atualizações de Licenciamento de PowerApps e Flow FY20](https://mbs.microsoft.com/partnersource/global/pricing-ordering/licensing-policies/Dyn365PricingandLicensing)
...
A Microsoft está a remover o pré-requisito da licença E3 Windows do Microsoft Defender Advanced Threat Protection (MDATP), permitindo que o MDATP para todos os dispositivos de cliente suportados.
...
Além disso, não há qualquer alteração às ofertas de Windows E5, Microsoft 365 E5 Segurança e Microsoft 365 E5, uma vez que essas ofertas continuarão a incluir o MDATP.
...
- 2 de março de 2020 Data de publicação atualizada: LANÇAMENTO DE GA (Go Live)
