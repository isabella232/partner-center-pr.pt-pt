...
Os parceiros podem agora aceder aos dados de análise de Informações parceiro através de uma API.
...
O valor-chave do acesso programático de dados de análise de Informações parceiros é a integração com sistemas e plataformas de BI internos para a criação de relatórios personalizados.

### <a name="next-steps"></a>Passos seguintes

[Reveja este guia](../insights-programmatic-get-started.md) para começar a usar o acesso programático aos dados de análise de Informações parceiros.

A nossa equipa de engenharia vai realizar [sessões de formação](https://globalpbocomm.eventbuilder.com/PartnerCenterInsightsAPIsTechnicalOverview) sobre este tema no final deste mês. A sessão destina-se às equipas técnicas dos nossos parceiros e será gravada para assistir a pedido.
...
Prestadores indiretos e parceiros de conta direta que transacionam serviços baseados em licenças no programa Fornecedor de Soluções em Nuvem
