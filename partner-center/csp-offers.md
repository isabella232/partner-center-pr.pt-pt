...
Os parceiros da Microsoft no programa Fornecedor de Soluções em Nuvem (CSP) têm um catálogo crescente de ofertas disponíveis. Pode vender toda a gama de [serviços na nuvem](https://partner.microsoft.com/cloud-solution-provider/products-and-services)da Microsoft e várias outras ofertas que mudam frequentemente. Para ver as ofertas do CSP para o mês em curso, inscreva-se no painel do [Centro de Parceiros](https://partner.microsoft.com/dashboard) e selecione o **azulejo de preços.**  
...
*Os serviços online* são o novo nome para o que é atualmente referido como *subscrições.* Para facilitar a encomenda de vários tipos de produtos num só local, integrámos o fluxo de tarefa "adicionar subscrição" ao fluxo de tarefas "adicionar produtos".
...
**Publisher** - Selecione quais tipos de produtos que pretende ver, quer aplicações criadas pela Microsoft quer por editoras de terceiros
...
## <a name="troubleshoot-catalog-purchases"></a>Compras de catálogos de resolução de problemas
