...
>
>- Para que, como revendedor indireto, crie pedidos de serviço para o seu cliente em Azure, o seu fornecedor indireto deve conceder-lhe acesso à conta Azure do cliente. Isto é diferente de administrar em nome dos clientes para o Office 365.
>
...
3. Mais tarde, reveja os pedidos de atendimento do seu cliente indo ao centro de administração do Office 365 e selecionando **Ver todos os bilhetes de apoio.**
...
### <a name="what-happens-if-i-sign-into-the-office-365-admin-center-portal-and-bypass-partner-center"></a>O que acontece se eu assinar no portal do centro de administração do Office 365 e contornar o Centro de Parceiros?

Se você assinar diretamente no centro de administração do Office 365, está a ver o centro no seu próprio contexto, e não no contexto de um cliente. É por isso que só deve assinar diretamente no centro de administração do Office 365 ao criar um pedido de serviço para as suas próprias subscrições.
...
Leia [o Suporte à Dinâmica da Microsoft](https://support.microsoft.com/help/4052881/faq-microsoft-dynamics-365-for-unified-operations-iur)
