...
Consulte a Cloud da [Microsoft para obter](https://download.microsoft.com/download/C/9/C/C9CA3002-DFC4-4ADA-841F-DF42AEC042FB/Microsoft_Azure_Government_Datasheet_EN_US.PDF) mais informações.
...
Para obter informações sobre a inscrição no CSP para o Microsoft Cloud para o Governo dos EUA, consulte [a inscrição em CSP para o Microsoft Cloud para o Governo dos EUA.](enroll-in-csp-for-microsoft-us-govt-cloud.md)
