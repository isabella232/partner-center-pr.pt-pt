...
Fornecedor de Soluções em Nuvem parceiros (CSP) em alguns países recebem valores de fatura que incluem impostos. Alguns destes parceiros pagam à autoridade fiscal local em vez da Microsoft. Se pagar à sua autoridade tributária local, tem de apresentar um pedido de retenção na fonte, incluindo o seu certificado de imposto para limpar o valor tributado das faturas anteriores. Estes valores apurados refletem-se na última coluna **de pagamento** na página **de Faturação** no Partner Center.

Os parceiros costumavam apresentar pedidos de retenção na fonte de imposto através da criação de pedidos de serviço (bilhetes de apoio a parceiros) no Partner Center. Este processo mudou em janeiro de 2020. Agora, os parceiros da CSP devem apresentar pedidos de retenção na fonte de imposto na página de **Faturação** em vez de criarem Pedidos de Apoio.

> [!IMPORTANT]
> Os parceiros só podem submeter pedidos de retenção na fonte para faturas parcialmente pagas. Para faturas totalmente pagas ou não pagas, contacte [o suporte](report-problems-with-partner-center.md) com o seu Certificado de Retenção Na Fonte Fiscal.
...
2. Selecione o azulejo **de Billing** e, em seguida, selecione **o histórico de Billing**.
...
3. **Selecione Enviar novo** junto à fatura para a quais pretende submeter um apuramento. O novo link de submissão irá levá-lo à página **de pedido de retenção na fonte de imposto.**
   ...
   :::image type="content" source="images/billing/billing-withholding-1.png" alt-text="Submeter nova retenção na fonte de imposto para uma fatura.":::

4. Reveja os dados da fatura para garantir que está a enviar o pedido para a fatura correta.

   :::image type="content" source="images/billing/billing-withholding-2.png" alt-text="Detalhes completos da retenção na fonte de impostos para uma fatura.":::
...
A equipa de revisão pode exigir que faça correções e reenviar um pedido antes de poder ser aprovado. Alterarão o estatuto para ação **do parceiro pendente.** Para corrigir e reenviar o pedido:
...
3. Encontre pedido de retenção na fonte fiscal. Os pedidos que necessitem da sua atenção terão um estatuto de "ação pendente do parceiro".
...
3. No histórico de **Faturação** da página **billing,** encontre o pedido de retenção na fonte de impostos. Os pedidos que necessitem da sua atenção terão um estatuto de "ação pendente do parceiro".
...
Os montantes limpos serão refletidos na secção de **histórico de faturação da página de Faturação**. Os montantes apurados aparecerão na última coluna **de pagamentos** junto à fatura para a a que o pedido foi apresentado.
...
O processamento dos pedidos de retenção na fonte de imposto deverá demorar dois dias a concluir, assumindo que o certificado e o montante fiscais estão corretos. Se houver alterações necessárias, demorará mais tempo, devido às correções que precisam de ser feitas e reapresentadas.

Se tiver dúvidas sobre o processo de pedido de crédito fiscal retenido, envie um bilhete para Apoio ao Parceiro. Vai precisar da identificação do pedido de retenção na fonte para resolver questões.

## <a name="german-tax-withholding"></a>Retenção à taxa alemã
