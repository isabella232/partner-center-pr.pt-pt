...
- Utilizando apenas caracteres especiais, como &$^# (ver [tabela](#table-of-special-characters) abaixo).
- Utilização apenas de espaços e/ou separadores.
- Utilizando abreviaturas autónomas da lista restrita, tais como LLC, Inc, etc. (ver [tabela](#table-of-abbreviations) abaixo).
- Utilizando nomes com extensões de Domínio Top-Level internet (TDL), tais como ".com", ".org", ".edu", ".club", etc. (ver [tabela](#table-of-top-level-domain-extensions) abaixo).
...
### <a name="table-of-abbreviations"></a>Tabela de abreviaturas

| Abbr. | Abbr. | Abbr. | Abbr. |
| ----- | ----- | ----- | ----- |
|"c p a" | "pty" | "L. l. c." | "gmbh" |
| "C.P.A." | "pty ltd" | "L.I.c." | "plc" |
| "L.L.P." | "pte ltd" | "l l p" | "Wll" |
| "c. p. a." | "privado limitado" | "corp" | "Lda" |
| "L. l. p." | "pvt" | "corporação" | "sarl" |
| "l l c" | "pvt ltd" | "inc" | "kft" |
| "Corp". | "zrt" | "incorporado" | "Ltd" |
| "llc". | "ooo" | "limitado" | "Ltd". |
| "Llp". | "llp" | "llc" | "sdn bhd"

### <a name="table-of-top-level-domain-extensions"></a>Tabela de extensões de domínio de nível superior

| O Extrato.  | O Extrato.  | O Extrato.  | O Extrato. |
| ----- | ----- | ----- | ----- |
| .ac | .ba | .ca | .de |
| .ad | .bb | .cc | .dj |
| .ae | .bd | .cd | .dk |
