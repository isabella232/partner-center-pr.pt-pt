---
title: Software como gestão de ciclo de vida por subscrição de serviço (SaaS)
...
- **Janela de pesquisa global** (topo) – Procure a sua subscrição SaaS pelo nome.
- **SaaS** – Lista todas as suas subscrições SaaS. Existem dois tipos de listas de SaaS; ver a seguinte secção.
- **Assinaturas** – Lista todas as subscrições Azure a que tem acesso como parte do seu inquilino. Para encontrar uma subscrição específica, utilize o filtro ou a janela de pesquisa.
...
As alterações que fizer a um plano a que está subscrito entrarão em vigor imediatamente. A faturação será proscamida de acordo com o prazo de faturação do plano atual. A alteração de planos requer permissões **de Proprietário** ou **Contribuinte.**
...
Para planos baseados em assentos, pode adicionar ou reduzir o número de utilizadores que definiu durante o processo de compra. A alteração do número de utilizadores a que está subscrito entrará em vigor entrará em vigor imediatamente e a faturação será proscrito de acordo com o prazo de faturação do plano atual. As alterações nos lugares só são possíveis dentro da gama mínima e máxima de lugares, tal como definida pela editora. Em alguns casos, você será obrigado a mudar um plano antes de mudar de lugar, e vice-versa.
...
A faturação recorrente permite-lhe gerir a renovação da sua subscrição SaaS. Quando a faturação recorrente estiver desligada, a subscrição e o serviço do SaaS terminarão na data de renovação. Só pode alterar a opção de renovação enquanto a subscrição estiver ativa. Uma subscrição SaaS encerrada e/ou cancelada não pode ser reativada; uma nova subscrição saaS precisa de ser criada no seu lugar.

### <a name="view-billing"></a>Ver faturação

Ver faturas para a sua subscrição Azure e produtos Azure Marketplace adquiridos com esta subscrição. Para o SaaS adquirido no portal, consulte a página de faturação na página de subscrição do SaaS na secção **Billing,** que irá redirecioná-lo para **a Gestão de Custos.**

A Gestão de Custos ajuda-o a compreender a sua quebra de fatura, a gerir a sua conta de faturação e subscrições, a monitorizar/controlar os gastos do Azure e a otimizar o uso de recursos. Permite analisar custos, criar e gerir orçamentos, e muito mais. Por exemplo, permite-lhe acompanhar o uso do medidor personalizado (para subscrições SaaS criadas após fevereiro de 2021, ou transferidas para um grupo de recursos). Saiba mais sobre gestão de custos na [Azure Cost Management + Documentação de faturação.](/azure/cost-management-billing/)

Se a sua compra foi efetuada através do Microsoft AppSource, pode ver as suas faturas no Microsoft Admin Center ao abrigo **de pagamentos & contas.**
...
### <a name="change-azure-subscription-andor-resource-group"></a>Alterar subscrição do Azure e/ou grupo de recursos
...
- Se a subscrição do SaaS não estiver no estado de Subscrição, verifique o seu estado de subscrição na secção SaaS ou na sua página de subscrição **SaaS.**
...
- Se a subscrição do SaaS for um recurso de nível de subscrição:
    - Precisa de permissões *de Read* ou *Proprietário/Colaborador* para a Assinatura Azure alvo.
    - Precisa de permissões *de Proprietário/Contribuinte* para o grupo de recursos-alvo.
    - Se já existir uma subscrição SaaS com o mesmo nome no grupo de recursos-alvo, selecione um grupo de recursos-alvo diferente.
- A subscrição e subscrição de recursos target Azure será submetida a todos os controlos realizados durante a compra. Para saber mais sobre as verificações de compras, consulte a secção [de Subscrição e configuração saaS](purchase-saas-offer-in-azure-portal.md#saas-subscription-and-configuration) na **Compra de uma oferta SaaS no portal Azure.**

## <a name="next-steps"></a>Passos seguintes

- Se já comprou uma oferta no mercado, vá a [Billing e Facturaing](billing-invoicing.md)
- Saiba mais sobre [opções de plano privado](private-offers.md)
